...
def create_layout2():
    return html.Div([
        ...
        html.Div([
            ...
            ], style={'flex': '1', 'padding': '10px', 'min-height': '500px'}),  # Flex to make both divs occupy equal space
        ...
        ], style={'display': 'flex', 'flexDirection': 'row', 'alignItems': 'stretch', 'gap': '10px'})  # Flexbox for side-by-side layout
    ])
